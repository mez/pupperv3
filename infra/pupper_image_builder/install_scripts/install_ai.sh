...
#   /home/pi/pupperv3/ai/llm-ui/agent-starter-python/.env
...
pip install python-dotenv pandas deepgram-sdk

pip install "numpy<2" "opencv-python" "pyzmq"

################################ Build pupper-rs GUI ################################
cd "$HOME_DIR/pupperv3/pupper-rs"
cargo build --release --target aarch64-unknown-linux-gnu

################################ Install systemd services ################################
bash "$HOME_DIR/pupperv3/pupper-rs/install_service.sh"
bash "$HOME_DIR/pupperv3/ai/llm-ui/agent-starter-python/install_service.sh"
...
echo "  $HOME_DIR/pupperv3/ai/llm-ui/agent-starter-python/.env"
